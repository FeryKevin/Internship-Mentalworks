...
if(!empty($_GET['id'])) 
{
    ...
    $db = connect();
    $statement = $db->prepare("SELECT * FROM customer WHERE id =?;");
...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if($isSuccess) 
    {
        ...
        if($results[0] == 0)
        {
            $statement = $db->prepare("UPDATE customer set name =? WHERE id = ?;");
        ...
        {
            $nameExiste = "Erreur : le nom du client est déjà utilisé.";
            $isSuccess = false;
        }
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <p class="titre">Modification du client</p>
                    </div>
        
                    <!-- formulaire client -->
                    <form class="form" role="form" action="<?php echo 'update_client.php?id=' . $id; ?>" method="post" enctype="multipart/form-data">                 
                    ...
                    <form class="form" action="update_client.php" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class='modal-dialog'>
                                <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                        <p>Vous êtes sur le point de supprimer un client, voulez-vous continuer ?</p>
                    ...
                    <button type="button" id="retour"><a href="../view_client.php">Retour</a></button>
                    ...
                    <form id="form" method="post" action="< ?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" role="form">
                        <div class="col-lg-5 col-lg-offset-1 col-md-12 col-sm-12">
                            ...
                            <button type="submit" class="addContact"><span class="glyphicon glyphicon-plus-sign" id="glyph"></span> Ajouter un contact</button><br>
                        </div>
                    </form>   -->                
